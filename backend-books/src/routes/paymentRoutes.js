...
const { recordPayment, getPayments, getAllPayments, getPaymentById, getDepositBalances } = require("../controllers/paymentController");
...
router.get("/payments/deposit-balances", authMiddleware, getDepositBalances);
