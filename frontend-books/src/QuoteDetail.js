...
function QuoteDetail() {
  ...
  const getCondensedMessage = () => {
    ...
    const docNumber = quote?.quote_number || "";
    const totalAmt = parseFloat(quote?.total_amount || 0).toFixed(2);
    const businessName = orgInfo?.name || "our business";
    return `Dear ${custName}, please find your Quote ${docNumber} from ${businessName}. Total: ₹${totalAmt}. Thank you. Regards, ${businessName}.`;
  };
          ...
          <>
            ...
            <div className="print-hide" style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "12px 24px", borderBottom: "1px solid #eaecf0", background: "#ffffff" }}>
              ...
              <div style={{ display: "flex", gap: "8px", alignItems: "center" }}>
                ...
                <button onClick={sendWhatsApp} style={toolbarBtnStyle} title="Send WhatsApp">
                ...
                <button onClick={sendSMS} style={toolbarBtnStyle} title="Send SMS">
