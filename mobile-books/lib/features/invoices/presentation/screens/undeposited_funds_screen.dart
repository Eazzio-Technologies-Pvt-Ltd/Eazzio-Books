...
class UndepositedFundsScreen extends ConsumerStatefulWidget {
  const UndepositedFundsScreen({super.key});

  @override
  ConsumerState<UndepositedFundsScreen> createState() => _UndepositedFundsScreenState();
}

class _UndepositedFundsScreenState extends ConsumerState<UndepositedFundsScreen> {
  ...
  List<Payment> _filterAndSort(List<Payment> list) {
    // 1. Filter by deposit_to = Undeposited Funds
    var result = list.where((p) => p.depositTo == 'Undeposited Funds').toList();
  ...
  Widget build(BuildContext context) {
    ...
    return ResponsiveScaffold(
      currentRoute: '/banking/undeposited-funds',
      appBar: AppBar(
        title: const Text('Undeposited Funds Ledger'),
      ),
      body: Column(
        children: [
          Padding(
                ...
                Expanded(
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      hintText: 'Search undeposited funds ledger...',
                  ...
                  children: [
                    ...
                    Expanded(
                      child: filtered.isEmpty
                          ? const Center(child: Text('No matching transactions in Undeposited Funds ledger.'))
                          : ListView.builder(
                                ...
                                return Card(
                                  ...
                                  child: ListTile(
                                    leading: const CircleAvatar(
                                      ...
                                      child: Icon(AppIcons.inventory_2_outlined, color: Colors.black),
                                    ),
                                    title: Text(
