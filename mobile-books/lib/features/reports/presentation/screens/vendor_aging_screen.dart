...
class VendorAgingScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<VendorAgingScreen> createState() => _VendorAgingScreenState();
}

class _VendorAgingScreenState extends ConsumerState<VendorAgingScreen> {
  String _searchQuery = '';
  ...
  Future<void> _selectAsOfDate(BuildContext context) async {
    final currentDate = ref.read(vendorAgingAsOfDateProvider);
    ...
    if (pickedDate != null) {
      ref.read(vendorAgingAsOfDateProvider.notifier).state = pickedDate;
    }
  }
                        ...
                        children: [
                          if (asOfDate != null)
                            IconButton(
                              ...
                              onPressed: () {
                                ref.read(vendorAgingAsOfDateProvider.notifier).state = null;
                              },
                            ),
                          ElevatedButton(
                      ...
                      child: Table(
                        ...
                        children: [
                          TableRow(
                            ...
                            children: const [
                              TableCell(child: Padding(padding: EdgeInsets.symmetric(vertical: 8.0), child: Text('Vendor Name', style: TextStyle(fontWeight: FontWeight.bold)))),
