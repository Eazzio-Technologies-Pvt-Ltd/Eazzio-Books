...
class DashboardService {
  ...
  Future<Map<String, dynamic>> getProjectedPayments() async {
    try {
      final response = await _networkClient.get('/accounts/projected-payments');
  ...
  Future<Map<String, dynamic>> getProjectedExpenses() async {
    try {
      final response = await _networkClient.get('/accounts/projected-expenses');
      return response.data as Map<String, dynamic>;
    } on DioException catch (e) {
